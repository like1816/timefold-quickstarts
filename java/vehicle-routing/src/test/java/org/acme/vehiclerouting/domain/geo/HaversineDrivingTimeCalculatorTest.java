...
class HaversineDrivingTimeCalculatorTest {
    ...
    void calculateDrivingTime() {
        Location Gent = new GeoLocation(51.0441461, 3.7336349);
        Location Brno = new GeoLocation(49.1913945, 16.6122723);
        ...
        Location Svolvaer = new GeoLocation(68.2359953, 14.5644379);
        Location Lulea = new GeoLocation(65.5887708, 22.1518707);
